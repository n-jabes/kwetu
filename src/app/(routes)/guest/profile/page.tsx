...
const GuestProfile = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    bio: 'Travel enthusiast exploring the beautiful landscapes of Rwanda. Love discovering unique places and experiencing local culture.'
  });
  ...
  const guestStats = [
    ...
    { label: 'Trip Rating', value: '4.9', icon: TrendingUp },
  ];
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg border border-purple-200">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-purple-600">{formData.email}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">Left a review</p>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">Booked a stay</p>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">Saved a place</p>
