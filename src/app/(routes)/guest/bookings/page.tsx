      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <button className="flex items-center justify-center px-3 py-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          {stats.map((stat, index) => {
            ...
            return (
              <div key={index} className="group bg-white/80 backdrop-blur-sm rounded-xl p-3 shadow-xl border border-slate-200/50 hover:shadow-2xl transition-all duration-300 hover:scale-105 cursor-pointer">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-xl border border-slate-200/50 overflow-hidden">
          <div className="flex items-center justify-between p-4 border-b border-slate-200/50 bg-gradient-to-r from-slate-50/50 to-transparent">
            <h2 className="text-lg font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">All Bookings</h2>
          ...
          <div className="p-4">
            <div className="space-y-3">
              {bookings.map((booking) => (
                <div key={booking.id} className="group border border-slate-200/50 rounded-xl p-3 hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] cursor-pointer bg-gradient-to-r from-slate-50/30 to-transparent hover:from-slate-100/50">
                  <div className="flex flex-col lg:flex-row lg:items-start space-y-3 lg:space-y-0 lg:space-x-3">
                    ...
                    <div className="flex-1 min-w-0 space-y-2">
                      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-2">
                        <div className="flex-1">
                          <h3 className="text-base font-bold text-slate-900 group-hover:text-emerald-700 transition-colors mb-1">{booking.property}</h3>
                          <div className="flex items-center text-sm text-slate-500 mb-1">
                            <MapPin className="w-4 h-4 mr-1" />{booking.location}
                          </div>
                        </div>
                        <div className={`inline-flex items-center px-2 py-1 rounded-full text-sm font-bold border-2 ${getStatusStyle(booking.status)} transition-all duration-300`}>
                      ...
                      {/* Bottom Section */}
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-2 pt-2 border-t border-slate-200/50">
